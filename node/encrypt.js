...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_encryptMessage')) {
        Object.defineProperty(Module['ready'], '_encryptMessage', { configurable: true, get: function() { abort('You are getting _encryptMessage on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_encryptMessage', { configurable: true, set: function() { abort('You are setting _encryptMessage on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _encryptMessage = Module["_encryptMessage"] = createExportWrapper("encryptMessage");
