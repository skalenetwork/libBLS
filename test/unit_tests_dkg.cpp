...
BOOST_AUTO_TEST_SUITE(DkgAlgorithm)
    ...
    std::vector<libff::alt_bn128_G2> SpoilVerifVector(std::vector<libff::alt_bn128_G2>& verif_vect) {
        ...
        switch (bad_coord_num) {
            case 0:
                bad_verif_vect.at(elem_to_spoil).X.c0 = SpoilSignCoord(verif_vect.at(elem_to_spoil).X.c0);
                break;
            case 1:
                bad_verif_vect.at(elem_to_spoil).X.c1 = SpoilSignCoord(verif_vect.at(elem_to_spoil).X.c1);
                break;
            case 2:
                bad_verif_vect.at(elem_to_spoil).Y.c0 = SpoilSignCoord(verif_vect.at(elem_to_spoil).Y.c0);
                break;
            case 3:
                bad_verif_vect.at(elem_to_spoil).Y.c1 = SpoilSignCoord(verif_vect.at(elem_to_spoil).Y.c1);
                break;
            case 4:
                bad_verif_vect.at(elem_to_spoil).Z.c0 = SpoilSignCoord(verif_vect.at(elem_to_spoil).Z.c0);
                break;
            case 5:
                bad_verif_vect.at(elem_to_spoil).Z.c1 = SpoilSignCoord(verif_vect.at(elem_to_spoil).Z.c1);
                break;
        }
    ...
    BOOST_AUTO_TEST_CASE(Verification2){
        for (size_t i = 0; i < 100; i++){
            ...
            for ( size_t i = 0; i < num_all; i++) {
                ...
                BOOST_REQUIRE(!obj.Verification(i, secret_shares.at(i) + libff::alt_bn128_Fr::one(), verif_vect));
                BOOST_REQUIRE(!obj.Verification(i, secret_shares.at(i), SpoilVerifVector(verif_vect)));
            }
        }
    }
