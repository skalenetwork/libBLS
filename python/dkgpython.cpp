...
static PyObject* PyDkgObject_GeneratePolynomial(struct PyDkgObject* self, PyObject* args, PyObject* kwds) {
  ...
  for (size_t i = 0; i < self->pDKG->GetT(); ++i) {
    PyList_SetItem(pRetVal, i, MakePythonString(BLSutils::ConvertToString<libff::alt_bn128_Fr>(ret_Val[i])));
  }

  return pRetVal;
}

static PyObject* PyDkgObject_VerificationVector(struct PyDkgObject* self, PyObject* args, PyObject* kwds) {
  ...
  for (size_t i = 0; i < self->pDKG->GetT(); ++i) {
    pol[i] = libff::alt_bn128_Fr(PyBytes_AsString(PyUnicode_AsUTF8String(PyList_GetItem(pyPolynomial, i))));
  }
  ...
  for (size_t i = 0; i < self->pDKG->GetT(); ++i) {
    ...
    PyTuple_SET_ITEM(pFirstCoord,  0, MakePythonString(BLSutils::ConvertToString(ret_Val[i].X.c0).c_str()));
    PyTuple_SET_ITEM(pFirstCoord,  1, MakePythonString(BLSutils::ConvertToString(ret_Val[i].X.c1).c_str()));
    PyTuple_SET_ITEM(pSecondCoord, 0, MakePythonString(BLSutils::ConvertToString(ret_Val[i].Y.c0).c_str()));
    PyTuple_SET_ITEM(pSecondCoord, 1, MakePythonString(BLSutils::ConvertToString(ret_Val[i].Y.c1).c_str()));
    PyTuple_SET_ITEM(pThirdCoord,  0, MakePythonString(BLSutils::ConvertToString(ret_Val[i].Z.c0).c_str()));
    PyTuple_SET_ITEM(pThirdCoord,  1, MakePythonString(BLSutils::ConvertToString(ret_Val[i].Z.c1).c_str()));
...
static PyObject* PyDkgObject_PolynomialValue(struct PyDkgObject* self, PyObject* args, PyObject* kwds) {
  PyObject* pyPolynomial;
  size_t point;
  ...
  PyObject* pRetVal = MakePythonString(BLSutils::ConvertToString<libff::alt_bn128_Fr>(ret_Val));

  return pRetVal;
}

static PyObject* PyDkgObject_SecretKeyContribution(struct PyDkgObject* self, PyObject* args, PyObject* kwds) {
  PyObject* pyPolynomial;
...
static PyObject* PyDkgObject_SecretKeyShareCreate(struct PyDkgObject* self, PyObject* args, PyObject* kwds) {
  ...
  for (size_t i = 0; i < self->pDKG->GetN(); ++i) {
    secretKeyContribution[i] = libff::alt_bn128_Fr(PyBytes_AsString(PyUnicode_AsUTF8String(PyList_GetItem(pySecretKeyContribution, i))));
  }
...
static PyObject* PyDkgObject_Verification(struct PyDkgObject* self, PyObject* args, PyObject* kwds) {
  size_t idx;
  ...
  for (size_t i = 0; i < self->pDKG->GetT(); ++i) {
    ...
    item.X = libff::alt_bn128_Fq2(libff::alt_bn128_Fq(PyBytes_AsString(PyUnicode_AsUTF8String(PyTuple_GetItem(PyList_GetItem(value, 0), 0)))),
...
static PyObject* PyDkgObject_GetPublicKeyFromSecretKey(struct PyDkgObject* self, PyObject* args, PyObject* kwds) {
  ...
  PyTuple_SET_ITEM(pFirstCoord,  0, MakePythonString(BLSutils::ConvertToString(public_key.X.c0).c_str()));
  PyTuple_SET_ITEM(pFirstCoord,  1, MakePythonString(BLSutils::ConvertToString(public_key.X.c1).c_str()));
  PyTuple_SET_ITEM(pSecondCoord, 0, MakePythonString(BLSutils::ConvertToString(public_key.Y.c0).c_str()));
  PyTuple_SET_ITEM(pSecondCoord, 1, MakePythonString(BLSutils::ConvertToString(public_key.Y.c1).c_str()));
  PyTuple_SET_ITEM(pThirdCoord,  0, MakePythonString(BLSutils::ConvertToString(public_key.Z.c0).c_str()));
  PyTuple_SET_ITEM(pThirdCoord,  1, MakePythonString(BLSutils::ConvertToString(public_key.Z.c1).c_str()));
...
static PyMethodDef PyDkgObject_methods[] = {
  { "GeneratePolynomial",        (PyCFunction)PyDkgObject_GeneratePolynomial,        METH_NOARGS,   "generate random polynomial"      },
  { "VerificationVector",        (PyCFunction)PyDkgObject_VerificationVector,        METH_VARARGS,  "generate public values"          },
  { "PolynomialValue",           (PyCFunction)PyDkgObject_PolynomialValue,           METH_VARARGS,  "calculate value at point"        },
  { "SecretKeyContribution",     (PyCFunction)PyDkgObject_SecretKeyContribution,     METH_VARARGS,  "generate shares for others"      },
...
static struct PyModuleDef dkgpython_definition = {
  PyModuleDef_HEAD_INIT,
  "dkgpython",
  "A Python module that prints 'Hi dkgpython world' from C code.",
  -1,
  dkgpython_methods
};
