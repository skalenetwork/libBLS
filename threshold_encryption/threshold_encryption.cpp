 ...
 *         - First: CipheredKey struct with (U,V,W) components of the threshold encryption -> Ciphered AES key
...
Ciphertext TE::aesCiphertextFromString(
